...
def test_get_caller_path():
    ...
    expected_path = os.environ["MOLA"]+"/tests/dependency_injector/user/test_retriever.py"
...
def test_get_wrap_module_path(backend):
    ...
    expected_path = os.environ["MOLA"]+f"/tests/dependency_injector/wrap/{backend}/test_retriever.py"
...
def test_get_backend_module_from(backend):
    expected_path = os.environ["MOLA"]+f"/tests/dependency_injector/wrap/{backend}/dummy_module.py"
