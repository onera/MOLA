...
class WorkflowSequentialScheduler():
    '''
    This class is instanciated by :py:meth:`WorkflowParallelScheduler._set_table_of_workflows`.
    ...
    run sequentially with the job file "job_sequence.sh".
    '''

    _sequential_job_filename = 'job_sequence.sh'
...
class WorkflowSender():
    ...
    _workflow_filename = 'workflow.cgns'
...
def find_matching_leaves(tree, patterns: list, operation=None) -> list:
    '''
