...
class WorkflowManager():
    ...
    .. code-block:: python
        ...
        workflow = Workflow(...)
        scheduler = WM.WorkflowManager(workflow, '/the/path/to/my/parametric/study/')

        for BCWall in ['WallViscous', 'WallInviscid']:
            scheduler.new_job(BCWall)  # There will be two job submitted, one for 'WallViscous' and one for 'WallInviscid'
    ...
    def __init__(self, workflow, root_directory='.', data_directory='SHARED_DATA', skip_if_exists=False):
