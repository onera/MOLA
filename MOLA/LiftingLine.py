...
NamesOfChordSpanThickwiseFrame = [
...
def buildLiftingLine(Span, RightHandRuleRotation=True, 
        PitchRelativeCenter=[0,0,0], PitchAxis=[1,0,0], **kwargs):
    '''
    ...
    ----------
        ...
        PitchRelativeCenter : list of 3 :py:class:`float`
            relative position of the pitch center (in meters).
            It is used by :py:func:`addPitch`.

        PitchAxis : list of 3 :py:class:`float`
