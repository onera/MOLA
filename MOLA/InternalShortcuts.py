...
def getDistributionFromHeterogeneousInput__(InputDistrib):
    ...
    if NodeKind == -1: # It is a node
        ...
        zone = W.linelaw(P1=InputDistrib['P1'], P2=InputDistrib['P2'], N=InputDistrib['N'],Distribution=InputDistrib)
        return buildResultFromNode__(zone)

    else:
        raise AttributeError('wing(): Type of Span argument not recognized. Check your input.')
