...
# ------------------------- INITIALIZE BODYFORCE -------------------------- #
    ...
    #     print(LocalBodyForceInputData)
    #     #RotAxis = LocalBodyForceInputData[0]['RotationAxis']
    # #print(RotAxis)
    # BodyForceSurface = I.getZones(J.load(fileName))[0]
    # J.save(BodyForceSurface, 'test.cgns')
    ...
    # Stacked = LL.stackBodyForceComponent(BodyForceSurface, RotAxis, **LocalBodyForceInputData)
    # print('TOTOOOOOO\n TOOOOOO')
    # #XXXX
    # # TODO: Check for uniqueness of RotorNames in getLocalBodyForceInputData
    # RotorName = 'Propeller'
    # BodyForceSurface[0] = RotorName

    # LL.addThickwiseCoordinate2BodyForceDisk(BodyForceSurface, setup.BodyForceInputData['RotationAxis'])
