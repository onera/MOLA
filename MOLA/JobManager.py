...
def saveJobsConfiguration(JobsQueues, AER, machine, DIRECTORY_WORK,
    ...
    ----------
        ...
        GeomPath : str
            location where geometry is located
...
def launchJobsConfiguration(
        templatesFolder='/home/lbernard/MOLA/Dev/TEMPLATES/WORKFLOW_AIRFOIL',
    ...
    Files2Copy = ['JobsConfiguration.py', config.GeomPath]
