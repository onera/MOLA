...
# PUMA
export PYTHONPATH=/stck/rboisard/bin/local/x86_64z/Puma_r335_centos6/lib/python2.7/site-packages:$PYTHONPATH
export LD_LIBRARY_PATH=/stck/rboisard/bin/local/x86_64z/Puma_r335_centos6/lib/python2.7:$LD_LIBRARY_PATH
export PUMA_LICENCE=/stck/rboisard/bin/local/x86_64z/Puma_r335_centos6/pumalicence.txt
