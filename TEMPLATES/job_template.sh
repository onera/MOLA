...
export MOLAVER=Dev
if [ -f "/tmp_user/sator/$USER/MOLA/$MOLAVER/env_MOLA.sh" ]; then
    source /tmp_user/sator/$USER/MOLA/$MOLAVER/env_MOLA.sh
elif [ -f "/tmp_user/juno/$USER/MOLA/$MOLAVER/env_MOLA.sh" ]; then
    source /tmp_user/juno/$USER/MOLA/$MOLAVER/env_MOLA.sh
else
    source /stck/$USER/MOLA/$MOLAVER/env_MOLA.sh
fi
